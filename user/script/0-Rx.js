...
function concat$1() {
    ...
    return function concatOperatorFunction(source) {
...
function partition(predicate, thisArg) {
    return [
        filter$1.call(this, predicate, thisArg),
        filter$1.call(this, not(predicate, thisArg))
    ];
}
...
function publishBehavior(value) {
    return multicast$1.call(this, new BehaviorSubject(value));
}
...
function publishReplay(bufferSize, windowTime, scheduler) {
    if (bufferSize === void 0) { bufferSize = Number.POSITIVE_INFINITY; }
    if (windowTime === void 0) { windowTime = Number.POSITIVE_INFINITY; }
    return multicast$1.call(this, new ReplaySubject(bufferSize, windowTime, scheduler));
}
...
function publishLast() {
    return multicast$1.call(this, new AsyncSubject());
}
 ...
 */
function share() {
    return multicast$1.call(this, shareSubjectFactory).refCount();
}
...
function shareReplay(bufferSize, windowTime, scheduler) {
    var subject;
    var connectable = multicast$1.call(this, function shareReplaySubjectFactory() {
        if (this._isComplete) {
            return subject;
        }
        else {
